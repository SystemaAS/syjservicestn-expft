...
public class SadmologLogger {
	...
	public void doLog(String serverRoot, String user, GenericDtoResponse dtoResponse){
		...
		try {
			...
			dto.setEllnrt(Integer.valueOf(dtoResponse.getEllnrt()));
			dto.setEllnrm(Integer.valueOf(dtoResponse.getEllnrm()));
			dto.setEllnrh(Integer.valueOf(dtoResponse.getEllnrh()));
			//log data
