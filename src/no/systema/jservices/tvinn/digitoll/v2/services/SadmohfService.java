...
@Service
public class SadmohfService {
	private static final Logger logger = LoggerFactory.getLogger(SadmohfService.class);
	...
	public List<SadmohfDto> getSadmohf(String serverRoot, String user, String ehlnrt, String ehlnrm, String ehlnrh) {
