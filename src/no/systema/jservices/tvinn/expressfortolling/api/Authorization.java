...
public class Authorization {
    ...
    public TokenResponseDto accessTokenRequestPostMovementPresentationICS2() throws RestClientException {
    	logger.info("accessTokenRequestPostMovementPresentationICS2()");
    	...
    	TokenRequestDto tokenRequest = new TokenRequestDto();
    	tokenRequest.setAssertion(difiJwtCreator.createRequestMovementPresentationJwt());
