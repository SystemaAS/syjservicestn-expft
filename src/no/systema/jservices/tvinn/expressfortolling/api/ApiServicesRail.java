...
/**
 * This class hosts all needed REST calls for Digitoll Rail.
 * 
 * @author oscardelatorre
 * @date 2024-03
 */
@Service
public class ApiServicesRail {
	private static Logger logger = LoggerFactory.getLogger(ApiServicesRail.class.getName());
	...
	@Value("${expft.basepath.movement.rail}")
    private String basePathMovementRail;
	
	@Value("${expft.basepath.movement.rail.version}")
    private String basePathMovementRailVersion;
	
	@Value("${expft.basepath.movement.rail.status.version}")
    private String basePathMovementStatusRailVersion;
	...
	public String postTransportDigitollV2(Transport transport, Map tollTokenMap ) {
		...
		TokenResponseDto maskinPortenResponseDto = authorization.accessTokenRequestPostMovementRail();
        ...
        //https://api-test.toll.no/api/movement/rail/v1/test-auth
		String path = UriComponentsBuilder.fromPath(this.basePathMovementRailVersion + "/transport").build().toUriString();
        ...
        apiClient.setBasePath(this.basePathMovementRail);
	...
	public String putTransportDigitollV2(Transport transport, String mrn, Map tollTokenMap ) {
		...
		String path = UriComponentsBuilder.fromPath(this.basePathMovementRailVersion + "/transport/" + mrn).build().toUriString();
		logger.warn(path);
	...
	public String getDocsReceivedTransportDigitollV2(String mrn) throws Exception {
		...
		String path = UriComponentsBuilder.fromPath(this.basePathMovementStatusRailVersion + "/transport/" + mrn + "/master-consignment/transport-document/status").build().toUriString();
		System.out.println(path);
		logger.warn(path);
	...
	public String getDocsReceivedTransportWithDescendantsDigitollV2(String mrn) throws Exception {
        ...
        //https://api-test.toll.no/api/movement/road/status/v2/transport/23NONJB08UP98SOBT7/master-consignment/transport-document/status
		String path = UriComponentsBuilder.fromPath(this.basePathMovementStatusRailVersion + "/transport/" + mrn + "/status-with-descendants").build().toUriString();
		System.out.println(path);
		logger.warn(path);
	...
	public String getDocsHousesReceivedTransportDigitollV2(String mrn) throws Exception {
        ...
        //https://api-test.toll.no/api/movement/rail/status/v1/transport/23NONJB08UP98SOBT7/house-consignment/transport-document/status
		String path = UriComponentsBuilder.fromPath(this.basePathMovementStatusRailVersion + "/transport/" + mrn + "/house-consignment/transport-document/status").build().toUriString();
		System.out.println(path);
		logger.warn(path);
	...
	public String getDocsReceivedHouseConsignmentDigitollV2(String mrn) throws Exception {
        ...
        //https://api-test.toll.no/api/movement/road/status/v2/house-consignment/23NONJB08UP98SOBT7/transport-document/status
		String path = UriComponentsBuilder.fromPath(this.basePathMovementStatusRailVersion + "/house-consignment/" + mrn + "/transport-document/status").build().toUriString();
		System.out.println(path);
		logger.warn(path);
	...
	public String getValidationStatusTransportDigitollV2(String lrn, Map tollTokenMap) throws Exception {
		...
		String path = UriComponentsBuilder.fromPath(this.basePathMovementStatusRailVersion + "/transport/validation-status/" + lrn).build().toUriString();
		logger.warn(path);
	...
	public String getMovementRailEntryDigitollV2(String mrn) throws Exception {
		
		TokenResponseDto maskinPortenResponseDto = authorization.accessTokenRequestPostMovementRailEntry();
		//System.out.println("difi-token:" + maskinPortenResponseDto.getAccess_token());
		TokenResponseDto tollResponseDto = authorization.accessTokenRequestPostToll(maskinPortenResponseDto);
		logger.warn("toll-token:" + tollResponseDto.getAccess_token());
	...
	public String postMasterConsignmentDigitollV2(no.systema.jservices.tvinn.digitoll.v2.dao.MasterConsignment mc, Map tollTokenMap) {
        ...
        //https://api-test.toll.no/api/movement/road/v1/test-auth
		String path = UriComponentsBuilder.fromPath(this.basePathMovementRailVersion + "/master-consignment").build().toUriString();
		System.out.println(path);
		logger.warn(path);
	...
	public String putMasterConsignmentDigitollV2(no.systema.jservices.tvinn.digitoll.v2.dao.MasterConsignment mc, String mrn, Map tollTokenMap) {
        ...
        //https://api-test.toll.no/api/movement/road/v1/test-auth
		String path = UriComponentsBuilder.fromPath(this.basePathMovementRailVersion + "/master-consignment/" + mrn).build().toUriString();
		System.out.println(path);
		logger.warn(path);
	...
	public String getValidationStatusMasterConsignmentDigitollV2(String lrn, Map tollTokenMap) throws Exception {
        ...
        //https://api-test.toll.no/api/movement/road/status/v2/ -->check the difference against all other end-points that do not have "status" in the path
		String path = UriComponentsBuilder.fromPath(this.basePathMovementStatusRailVersion + "/master-consignment/validation-status/" + lrn).build().toUriString();
		System.out.println(path);
		logger.warn(path);
	...
	public String getDocsReceivedMasterConsignmentDigitollV2(String mrn) throws Exception {
		...
		String path = UriComponentsBuilder.fromPath(this.basePathMovementStatusRailVersion + "/master-consignment/" + mrn + "/transport-document/status").build().toUriString();
		System.out.println(path);
		logger.warn(path);
	...
	public String getDocsReceivedMasterConsignmentWithDescendantsDigitollV2(String mrn) throws Exception {
		...
		String path = UriComponentsBuilder.fromPath(this.basePathMovementStatusRailVersion + "/master-consignment/" + mrn + "/status-with-descendants").build().toUriString();
		System.out.println(path);
		logger.warn(path);
	...
	public String postHouseConsignmentDigitollV2(no.systema.jservices.tvinn.digitoll.v2.dao.HouseConsignment hc, Map tollTokenMap) {
        ...
        //https://api-test.toll.no/api/movement/road/v1/test-auth
		String path = UriComponentsBuilder.fromPath(this.basePathMovementRailVersion + "/house-consignment").build().toUriString();
		System.out.println(path);
		logger.warn(path);
	...
	public String putHouseConsignmentDigitollV2(no.systema.jservices.tvinn.digitoll.v2.dao.HouseConsignment hc, String mrn, Map tollTokenMap) {
        ...
        //https://api-test.toll.no/api/movement/road/v1/test-auth
		String path = UriComponentsBuilder.fromPath(this.basePathMovementRailVersion + "/house-consignment/" + mrn).build().toUriString();
		System.out.println(path);
		logger.warn(path);
	...
	public String getValidationStatusHouseConsignmentDigitollV2(String lrn, Map tollTokenMap) throws Exception {
        ...
        //https://api-test.toll.no/api/movement/road/status/v2/ -->check the difference against all other end-points that do not have "status" in the path
		String path = UriComponentsBuilder.fromPath(this.basePathMovementStatusRailVersion + "/house-consignment/validation-status/" + lrn).build().toUriString();
		System.out.println(path);
		logger.warn(path);
	...
	/**
	 * Only for Rail and testing requirement end-point
	 * @return
	 * @throws Exception
	 */
