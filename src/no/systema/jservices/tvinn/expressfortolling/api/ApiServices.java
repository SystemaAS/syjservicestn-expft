...
//        return testGetDtos();
	...
	/**
	 * shows all master ref. to this transport
	 * @param mrn
	 * @return
	 * @throws Exception
	 */
	public String getDocsReceivedTransportDigitollV2(String mrn) throws Exception {
		...
		String path = UriComponentsBuilder.fromPath(this.basePathMovementStatusRoadVersion + "/transport/" + mrn + "/master-consignment/transport-document/status").build().toUriString();
		System.out.println(path);
		logger.warn(path);
	...
	public String getDocsReceivedTransportWithDescendantsDigitollV2(String mrn) throws Exception {
        ...
        //https://api-test.toll.no/api/movement/road/status/v2/transport/23NONJB08UP98SOBT7/master-consignment/transport-document/status
		String path = UriComponentsBuilder.fromPath(this.basePathMovementStatusRoadVersion + "/transport/" + mrn + "/status-with-descendants").build().toUriString();
		System.out.println(path);
		logger.warn(path);
	...
	public String getDocsReceivedHouseConsignmentDigitollV2(String mrn) throws Exception {
		...
		String path = UriComponentsBuilder.fromPath(this.basePathMovementStatusRoadVersion + "/house-consignment/" + mrn + "/transport-document/status").build().toUriString();
		System.out.println(path);
		logger.warn(path);
