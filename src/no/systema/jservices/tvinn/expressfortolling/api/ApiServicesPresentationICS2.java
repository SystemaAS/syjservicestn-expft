...
/**
 * This class hosts all needed REST calls for ICS2 - Presentation.
 * 
 * @author oscardelatorre
 * @date Maj 2024
 */
@Service
public class ApiServicesPresentationICS2 {
	private static Logger logger = LoggerFactory.getLogger(ApiServicesPresentationICS2.class.getName());
	...
	@Value("${expft.basepath.movement.presentation.version}")
	private String basePathMovementPresentationVersion;
	 ...
	 * @return
	 */
	public String postEntrySummaryDeclarationDigitollV2(Ics2Ens ens, Map tollTokenMap ) {
		  
		TokenResponseDto maskinPortenResponseDto = authorization.accessTokenRequestPostMovementPresentationICS2();
		...
		try {
			...
			String json = ow.writeValueAsString(ens);
			logger.info(json);
        ...
        //https://api-test.toll.no/api/movement/presentation/v1/entry-summary-declaration
		String path = UriComponentsBuilder.fromPath(this.basePathMovementPresentationVersion + "/entry-summary-declaration").build().toUriString();
	...
	public String getDocsReceivedTransportDigitollV2(String mrn) throws Exception {
		...
		String path = UriComponentsBuilder.fromPath(this.basePathMovementStatusAirVersion + "/transport/" + mrn + "/master-consignment/transport-document/status").build().toUriString();
		System.out.println(path);
		logger.warn(path);
	...
	public String getDocsReceivedTransportWithDescendantsDigitollV2(String mrn) throws Exception {
		...
		String path = UriComponentsBuilder.fromPath(this.basePathMovementStatusAirVersion + "/transport/" + mrn + "/status-with-descendants").build().toUriString();
		System.out.println(path);
		logger.warn(path);
	...
	public String getDocsHousesReceivedTransportDigitollV2(String mrn) throws Exception {
		...
		String path = UriComponentsBuilder.fromPath(this.basePathMovementStatusAirVersion + "/transport/" + mrn + "/house-consignment/transport-document/status").build().toUriString();
		System.out.println(path);
		logger.warn(path);
	...
	public String getMovementAirEntryDigitollV2(String mrn) throws Exception {
		
		TokenResponseDto maskinPortenResponseDto = authorization.accessTokenRequestPostMovementAirEntry();
		//System.out.println("difi-token:" + maskinPortenResponseDto.getAccess_token());
		TokenResponseDto tollResponseDto = authorization.accessTokenRequestPostToll(maskinPortenResponseDto);
		logger.warn("toll-token:" + tollResponseDto.getAccess_token());
		...
		String path = UriComponentsBuilder.fromPath( this.basePathMovementStatusAirVersion + "/entry/status/" + mrn).build().toUriString();
		System.out.println(path);
		logger.warn(path);
	...
	public String getDocsReceivedMasterConsignmentWithDescendantsDigitollV2(String mrn) throws Exception {
		...
		String path = UriComponentsBuilder.fromPath(this.basePathMovementStatusAirVersion + "/master-consignment/" + mrn + "/status-with-descendants").build().toUriString();
		System.out.println(path);
		logger.warn(path);
	...
	public String getDocsReceivedHouseConsignmentDigitollV2(String mrn) throws Exception {
		...
		String path = UriComponentsBuilder.fromPath(this.basePathMovementStatusAirVersion + "/house-consignment/" + mrn + "/transport-document/status").build().toUriString();
		System.out.println(path);
		logger.warn(path);
